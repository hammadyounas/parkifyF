                    ...
                    
{
    ...
    return (
        ...
        setSpinVisible(true)
                                ...
                                console.log( `http://localhost:3333/user/findAvailableParking?parkingArea=Area ${selectedArea}&startDate=${dateValue}&startingTime=${timeValue}&hours=${hoursValue}&endDate=${dateValue}`)
                                try {
