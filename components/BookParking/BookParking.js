    ...
    const handleBookParkingClick = async() => {
        ...
        console.log('ba bum ba bum')
            try {
                ...
                await axios.post(
                    `https://parkify-backend.vercel.app/user/bookParking`,
                        ...
                        <Button type="primary" htmlType="submit"
                            ...
                            onClick={async () => {
                                ...
                                try {
                                    ...
                                    await axios.get(
                                        `https://parkify-backend.vercel.app/user/findAvailableParking?parkingArea=${selectedArea}&startDate=${startDateValue}&endDate=${endDateValue}`,
                                         {
...
//                                 console.log( `https://parkify-backend.vercel.app/user/findAvailableParking?parkingArea=${selectedArea}&startDate=${dateValue}&startingTime=${timeValue}&hours=${hoursValue}&endDate=${dateValue}`)
//                                 try {

//                                     await axios.get(
//                                         `https://parkify-backend.vercel.app/user/findAvailableParking?parkingArea=${selectedArea}&startDate=${dateValue}&startingTime=${timeValue}&hours=${hoursValue}&endDate=${dateValue}`,
//                                          {
